...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-&$-5k0#1=&i3w0d5kp7kql-08l+)#-d-l_peykr9pypak#$f$f')
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'frontend_dist', BASE_DIR / 'staticfiles'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Serve the built React app (backend/frontend_dist) at the root URL
