...
**Project:** Jan Jimels Party Needs
**Generated:** 2026-09-08 17:07:59
**Category:** Event Management

---

## Brand Override (owner decision — takes priority over generated values)

### Color Palette (navy & gold brand identity)

| Role | Hex | Tailwind Token |
|------|-----|--------------|
| Primary / Dark | `#14274D` | `navy-800/900` |
| Primary Deep | `#071126` | `navy-950` |
| Accent / CTA | `#D4AF37` | `gold-500` |
| Accent Light | `#F0D47A` | `gold-300` |
| Background (light) | `#FFFFFF` | white |
| Background (soft) | `#EEF2F9` | `navy-50` |
| Text | `#14274D` | `navy-900` |
| Muted text | `#475569` | slate-600 |

The generated purple/orange palette is **ignored** — always use the tokens above.

### Typography

- **Headings:** Playfair Display (600/700/800)
- **Body:** Poppins (300–600)
- Mood: editorial + friendly, luxury party/event feel, type-as-hero for headline

### Key Effects (apply to all pages)

- Large section gaps (48px+), bold hover (color shift, 150–300ms)
- Large type (32px+ headlines), high-contrast duotone navy/gold
- Static hero + non-pulsing CTA when reduced motion is requested
